  ...
  <div class="el-iframe-wrap" :style="{ height: ensureUnit(val.height, '400px') }">
    ...
    <div v-else-if="!val.src" class="el-iframe-placeholder">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        ...
        <path d="M8 10l3 3-3 3"/><line x1="13" y1="16" x2="16" y2="16"/>
      </svg>
      <span>請輸入嵌入網址</span>
    </div>
...
<style scoped>
.el-iframe-wrap { width: 100%; position: relative; overflow: hidden; border-radius: 4px; }
.el-iframe      { width: 100%; height: 100%; border: none; display: block; }
.el-iframe.is-hidden { display: none; }
...
.el-iframe-placeholder svg   { width: 28px; height: 28px; }
.el-iframe-placeholder small { font-size: 10px; color: #d1d5db; word-break: break-all; max-width: 90%; text-align: center; }
.el-iframe-placeholder--error { background: #fff5f5; color: #ef4444; }
.el-iframe-placeholder--error svg { color: #ef4444; }
</style>
